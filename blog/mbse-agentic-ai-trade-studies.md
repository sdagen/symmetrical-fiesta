...
Requirements verified by executed simulation now stand at 10 of 28, each with its own design-space sweep, the suite has grown to 72 tests, and every sweep so far has paid for itself with either a margin number nobody had or a finding nobody expected.
