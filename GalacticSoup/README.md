...
| `architecture/PhysicalEverSimmer.slx` | Physical (Variant C) | Resilience/autonomy-optimized physical realization — "EverSimmer." |
...
| `behavior/plants/BehPlant{HyperCook,LeanBroth,EverSimmer}.slx` | Behavioral | Top-level behavioral plant models, one per physical variant, composing the component library per variant topology and parameters. |
