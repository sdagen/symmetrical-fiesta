...
Each tier maps to an existing analysis document: the analysis tier pins values from [`05_trade_study_methodology.md`](05_trade_study_methodology.md) and [`08_formal_compliance_gate.md`](08_formal_compliance_gate.md); the system tier pins the simulated figures from [`09_behavioral_models.md`](09_behavioral_models.md) and [`10_behavioral_trade_update.md`](10_behavioral_trade_update.md).
