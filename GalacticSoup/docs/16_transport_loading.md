...
Artifacts: the dock-and-transit path in [`../behavior/build/buildInlineBehaviors.m`](../behavior/build/buildInlineBehaviors.m), [`../analysis/runTransportSweep.m`](../analysis/runTransportSweep.m), [`../tests/tTransport.m`](../tests/tTransport.m), the `TransportLoading` suite in [`../tests/GalacticSoupSystemTests.mldatx`](../tests/GalacticSoupSystemTests.mldatx). Decision: ADR-028 in [`07_decision_log.md`](07_decision_log.md).
