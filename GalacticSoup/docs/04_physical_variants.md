...
Models (in progress): `../architecture/physical/PhysicalHyperCook.slx`, `../architecture/physical/PhysicalLeanBroth.slx`, `../architecture/physical/PhysicalEverSimmer.slx`
