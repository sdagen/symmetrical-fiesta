...
% Composite members (IronLadle cells) resolve capacity as interior chain min.
stages.HyperCook = { ...
...
support.IronLadle = {'ControlTriad','RedundantReactorPair','GravityCompMesh'};

variants = {'HyperCook','PhysicalHyperCook'; 'LeanBroth','PhysicalLeanBroth'; 'IronLadle','PhysicalIronLadle'};
results = struct([]);
